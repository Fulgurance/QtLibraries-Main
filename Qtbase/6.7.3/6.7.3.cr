class Target < ISM::Software
    ...
    def configure
        ...
        runCmakeCommand(arguments:      "-B #{buildDirectoryPath}                                           \
                                        ...
                                        -DFEATURE_xcb=#{option("Libxkbcommon") ? "ON" : "OFF"}             \
                                        -DFEATURE_xcb_xlib=#{option("Libxkbcommon") ? "ON" : "OFF"}        \
                                        -DFEATURE_xkbcommon=#{option("Libxkbcommon") ? "ON" : "OFF"}       \
                                        -DFEATURE_xkbcommon_x11=#{option("Libxkbcommon") ? "ON" : "OFF"}   \
                                        -DFEATURE_xlib=#{option("Libxkbcommon") ? "ON" : "OFF"}            \
